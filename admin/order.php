                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Bảng đơn hàng</h6>
                        </div>
                    </div>
                    <div class="card-body px-0 pb-2">
                        <div class="table-responsive p-0">
                            <a href='./order.php' style="margin-left: 20px"><span class="badge badge-sm bg-gradient-secondary">Tất cả</span></a>
                            <a href='./order.php?type=2' style="margin-left: 20px"><span class="badge badge-sm bg-gradient-primary">Đặt hàng</span></a>
                            <a href='./order.php?type=3' style="margin-left: 20px"><span class='badge badge-sm bg-gradient-info'>Vận chuyển</span></a>
                            <a href='./order.php?type=4' style="margin-left: 20px"><span class="badge badge-sm bg-gradient-success">Hoàn thành</span></a>
                                        ...
                                        <td class="align-middle text-center text-sm">
                                            <?php  
                                                if ($order['status'] == 2){
                                                    ...
                                                    echo '<span class="badge badge-sm bg-gradient-info">Giao hàng</span>';
