                                    ...
                                    <form action="code.php" method="POST" enctype="multipart/form-data"><!-- Uploads image -->
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" id="full-name" required value="<?=$data['name']?>" name="name" placeholder="Nhập tên loại" class="form-control"> 
                                            </div>                               
                                            <div class="col-md-12">
                                            <br>
                                            ...
                                            <br>
                                                ...
                                                <input type="text" required value="<?=$data['description']?>" name="description" placeholder="Thêm mô tả" class="form-control">
                                            </div>                              
                                            <div class="col-md-12">
                                            <br>
